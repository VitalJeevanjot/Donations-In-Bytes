...
eventBus.once('headless_wallet_ready', () => {
	...
	eventBus.on('paired', (from_address, pairing_secret) => {
		...
		device.sendMessageToDevice(from_address, 'text', 'I heard that you want to donate to abc, Please click this [link](byteball:D6Z5A3AC4O7IMFBKUNUDMFL33SGE5J2Z?amount=1000000000) to complete your donation of 1 GB');
	});
